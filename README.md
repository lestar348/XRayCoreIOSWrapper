...
Framework source code in  [Mobile wrapper XrayCore](https://github.com/lestar348/xray-core-mobile-wrapper), this wrapper supports macos, ios and ios simulator
